    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="{{ asset('images/logo2.png') }}" alt="Academia Logo" width="30" height="30" class="d-inline-block align-top">
                <strong class = "nome-academia">FitManage</strong>
            </a>
